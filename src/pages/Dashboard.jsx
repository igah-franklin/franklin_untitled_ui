  ...
  return (
        ...
        <form>
          ...
          <div className='flex flex-start gap-5 mt-5'>
            ...
            <div className='flex flex-col translate-y-4'>
              ...
              <input type="text" name="emailHolder" id="emailHolder" value='billing@untitledui.com' className='lg:w-[30rem] outline-0  mt-2 bg-sideBar border border-1 border-dividerLine pl-8 rounded-[0.375rem] py-1'  />
    ...
    <div className=' flex flex-col md:flex-row mt-10'>
      ...
      <div className='w-full md:w-2/3 md:ml-[5rem]'>
        <form>
        {/* <label htmlFor="visa">
            <input type="checkbox" name="visa" id="visa" checked className='peer absolute opacity-[0]'/>
          ...
          <label htmlFor="visa" className='relative'>
            <input type="checkbox" name="visa" id="visa" className='peer absolute opacity-[0]'/>
          <div className='flex flex-start justify-between gap-5 border border-[#D6BBFB] px-10 py-5 rounded-[8px] mt-5 cursor-pointer peer-checked:bg-[#F9F5FF]'>
            <div className='flex gap-5'>
            <img src={visaCard} alt="visacard" className='h-[30px] w-[30px] md:h-[40px] md:w-[40px]' />
          ...
          <label htmlFor="mastercard" className='relative'>
            <input type="checkbox" name="mastercard" id="mastercard" className='peer absolute opacity-[0]'/>
          <div className='flex flex-start justify-between gap-5 border border-[#D6BBFB] px-10 py-5 rounded-[8px] mt-5 cursor-pointer peer-checked:bg-[#F9F5FF]'>
            <div className='flex gap-5'>
    ...
    <div className='flex justify-between items-center font-normal text-sm mt-5'>
      ...
      <button className='flex items-center gap-3 py-2 px-4 bg-sideBar border border-[#D0D5DD] text-[#344054] font-sm rounded'><span><CloudDownloadIcon/></span>Download all</button>
    </div>
    <DataTable/>
    </div>
  )

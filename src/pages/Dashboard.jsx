      ...
      <div className="w-[49.75rem mt-7 z-[100]">
        ...
        <div className=" flex flex-col md:flex-row">
          <div className="w-full md:w-1/3">
            <h3 className="text-[#344054] font-normal text-xsm">
              Contact email
            </h3>
            ...
            <form onSubmit={formSubmit}>
              <label htmlFor="visa" className="visa__label relative">
                ...
                <div className="visa__inner flex flex-start justify-between gap-2 border border-[#D6BBFB] px-10 py-5 rounded-[8px] mt-5 cursor-pointer peer-checked/card:bg-[#F9F5FF]">
                  ...
                  <img
                    src={neutralCheckIcon}
                    alt=""
                    className="visa__neutral__badge -translate-y-2"
                  />
                  <img
                    src={purpleCheckIcon}
                    alt=""
                    className="hidden visa__pink__badge -translate-y-2"
                  />
                </div>
              </label>
              <label
                htmlFor="mastercard"
                className="mastercard__label relative"
              >
                <input
                  type="radio"
                  name="payment"
                ...
                <div className="mastercard__inner flex flex-start justify-between gap-2 border border-[#D6BBFB] px-10 py-5 rounded-[8px] mt-5 cursor-pointer peer-checked/card:bg-[#F9F5FF]">
                  ...
                  <img
                    src={neutralCheckIcon}
                    alt=""
                    className="neutral__badge -translate-y-2"
                  />
                  <img
                    src={purpleCheckIcon}
                    alt=""
                    className="hidden pink__badge -translate-y-2"
                  />
                </div>
              </label>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center font-normal text-sm mt-5">
          <h3 className="text-[#101828] text-[18px]">Billing history</h3>
          <button className="w-2/3 md:w-auto flex items-center gap-3 py-2 px-4 bg-sideBar border border-[#D0D5DD] text-[#344054] font-sm rounded mt-2 md:mt-0">
            <span>
              <CloudDownloadIcon />
            </span>
            Download all
